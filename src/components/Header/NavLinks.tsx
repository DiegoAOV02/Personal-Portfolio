import { FolderKanban, Home, BriefcaseBusiness, Code } from "lucide-react";
...
const navLinks: NavLink[] = [
  ...
  { name: "Experience", href: "#resume", icon: BriefcaseBusiness },
  { name: "Tech", href: "#tech-stack", icon: Code },
];
